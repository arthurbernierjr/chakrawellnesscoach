...
class SpiritualNurse extends React.Component {
  componentDidMount() {
    window.scrollTo(0, 0);
  ...
  render() {
    ...
    return (
      <div>
        ...
        />
        <Parallax image={require("assets/img/main-imgs/slider1.jpg")} filter="dark">
...
export default withStyles(blogPostPageStyle)(SpiritualNurse);
