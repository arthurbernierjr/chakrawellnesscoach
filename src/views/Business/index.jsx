  ...
  render() {
    ...
    return (
      <div>
        ...
        />
        <Parallax image={require("assets/img/main-imgs/slider3.jpg")} filter="dark">
          <div className={classes.container}>
            <GridContainer justify="center">
              <GridItem md={8} className={classes.textCenter}>
                <h1 className={classes.title}>
                  Become a Business Owner and Make Money
                    With Me
                </h1>
                <br />
...
export default withStyles(blogPostPageStyle)(Business);
