    ...
    <List className={classes.list + " " + classes.mlAuto}>
      ...
      <ListItem className={classes.listItem}>
        <CustomDropdown
          ...
          dropdownList={[
            ...
            > <LineStyle className={classes.dropdownIcons} /> About Us
            </Link>
          ]}
        />
      </ListItem>
        ...
        <CustomDropdown
          ...
          dropdownList={[
            <Link to="/contact-us" className={classes.dropdownLink}>
              <AccountBalance className={classes.dropdownIcons} /> Contact Us
            </Link>
          ]}
        />
        <ListItem className={classes.listItem}>
      ...
      <ListItem className={classes.listItem}>
        <Button
          ...
          round
        ><Link to="/e-commerce" className={classes.dropdownLink}>
        <ShoppingCart className={classes.icons} /> Get The Book Now
        </Link>
        </Button>
      </ListItem>
    </Link>
